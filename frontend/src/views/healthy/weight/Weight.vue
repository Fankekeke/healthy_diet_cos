...
import BulletinAdd from './WeightAdd.vue'
import BulletinEdit from './WeightEdit.vue'
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/cos/weight-record-info/' + ids).then(() => {
