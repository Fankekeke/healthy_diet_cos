<template>
  <a-modal v-model="show" title="修改营养设定" @cancel="onClose" :width="450">
    ...
    <a-form :form="form" layout="vertical">
      <a-row :gutter="20">
        <a-col :span="24">
          <a-form-item label='热量' v-bind="formItemLayout">
            <a-input v-decorator="[
            'heat',
        ...
        <a-col :span="24">
          <a-form-item label='蛋白质' v-bind="formItemLayout">
            <a-input v-decorator="[
            'protein',
  ...
  methods: {
    ...
    handleSubmit () {
      ...
      this.form.validateFields((err, values) => {
        ...
        if (!err) {
          this.loading = true
          this.$put('/cos/nutrition-rule-info', {
            ...values
          }).then((r) => {
            this.reset()
            this.$emit('success')
