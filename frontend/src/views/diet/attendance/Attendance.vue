<template>
  <a-card :bordered="false" class="card-area">
    <a-button type="primary" @click="checkAttendance" :disabled="checkCount > 0">{{ checkCount > 0 ? '已打卡' : '打卡' }}</a-button>
    <a-calendar>
...
export default {
  ...
  methods: {
    ...
    checkAttendance () {
      this.$post(`/cos/attendance-info`, {userId: this.currentUser.userId}).then((r) => {
